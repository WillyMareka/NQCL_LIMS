<style type="text/css">
.tg, .tk  {border-collapse:collapse;border-spacing:0;border-color:#bbb;}
...
<table class="tg" id="table_update" style="width:1000px; ">
    ...
    <tbody>
        <tr><td colspan="3"></td><td></td><td colspan="3"><input type="button" id="save_su" value="Submit" class="submit-button" /> <input type="button" id="cancel" value="Cancel" class="submit-button" /></td></tr>
    </tbody>
</table>
</form>
</div>
...
function getData(){
	...
	if (typeof rtable == 'undefined') {
		...
		"fnCreatedRow":function(nRow, aData, iDataIndex) {
			if(unit != '5'){
				//console.log($('td a', nRow).not('.more_info, .s_u, .s_ue,.a_detail').replaceWith('<span>N/A</span>'));
			}
		},
	"bJQueryUI": true,
	"aoColumns": [
...
//    });
		...
		"mRender":function(data, type, row){
			//if(row.assign_status == "0" && row.quotation_status == "0"){
				return '<a class="s_u" href = "#sample_update" id='+row.request_id+' >+Add </a> || <a class="s_ue" href = "#Edit_log" id='+row.request_id+' >Edit</a>';
