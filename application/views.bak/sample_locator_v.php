...
<!--                    <td><?php echo $gps->id; ?></td>-->
                    ...
                    <?php if ($gps->stage === '1') { ?>
                        <td style=" width:50px; padding: 0px; text-align: center; font-weight: bolder; color: black;"><div id="start" >0%.. Completed!</div></td>                   
                    <?php } else if ($gps->stage === '2') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="sec" >10%..</div></td>                   
                    <?php } else if ($gps->stage === '3') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="an-sup" >20%..</div></td>
                    <?php } else if ($gps->stage === '4') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="sup" >30%..</div></td>                   
                    <?php } else if ($gps->stage === '5') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="an-doc" >40%..</div></td>
                    <?php } else if ($gps->stage === '6') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="doc" >50%..</div></td>
                    <?php } else if ($gps->stage === '7') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="rev" >60%..</div></td>
                    <?php } else if ($gps->stage === '8') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="doc2" >70%..</div></td>
                    <?php } else if ($gps->stage === '9') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="ddir" >80%..</div></td>
                    <?php } else if ($gps->stage === '10') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="sddir" >90%..</div></td>
                    <?php } else if ($gps->stage === '11') { ?>
                        <td style=" width:50px; padding: 0px;"><div id="doc3" >100% Completed!</div></td>
                    <?php } ?>
