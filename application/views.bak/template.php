        ...
        <div id="wrapper">
            <div id="top-panel">
               ...
               <a href="<?php echo base_url(); ?>request_management" class="top_menu_link  first_link <?php
                ...
                if ($quick_link == "new_order") {
                    echo " top_menu_active ";
                }
                    ?>">District Orders</a>
                                   <a href="<?php echo base_url(); ?>user_management/dist_manage" class="top_menu_link  first_link <?php if ($current == "user_management") {
                    echo " top_menu_active ";
                } ?>">Users</a>
                <?php }
                ?>
                <?php if ($user_is_moh) {
                    ?> 	
                                   <a href="<?php echo base_url(); ?>user_management/moh_manage" class="top_menu_link  first_link <?php if ($current == "user_management") {
                    echo " top_menu_active ";
                } ?>">Users</a>
                <?php }
                ?>
               ...
               <a ref="#" class="top_menu_link" id="my_profile_link"><?php echo "NQCL" ?></a>
                ...
                <label class="labrefno" style="float: right; margin-right: 40px; margin-top: 70px;">Welcome:  <?php /* echo $this -> session -> userdata('user_id') */; ?> <?php
 ...
 <?php //echo  'inbox ('. $messages. ')';?>
            ...
            <div id="inner_wrapper"> 
                <!-- MOH USR-->
                    ...
                    if ($quick_link == "unconfirmed_orders") {
                        echo "top_menu_active";
                    }
