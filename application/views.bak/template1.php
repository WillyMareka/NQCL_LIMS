...
<link href="<?php echo base_url().'Scripts/jwizard/dist/jquery.jWizard.css'?>" type="text/css" media="screen" rel="stylesheet"/> 
...
<script src="<?php echo base_url().'Scripts/jquery-ui-1.10.3.custom.min.js'?>" type="text/javascript"></script>
...
<script src="<?php echo base_url().'Scripts/jwizard/dist/jquery.jWizard.js'?>" type="text/javascript"></script>
...
<script src="<?php echo base_url().'Scripts/tabletools/media/js/TableTools.js'?>" type="text/javascript"></script>
<script src="<?php echo base_url().'Scripts/tabletools/media/js/ZeroClipboard.js'?>" type="text/javascript"></script>
