...
<script>
 ...
 <?php echo form_open('friability/approve/'.$labref.'/'.$r.'/'.$c); ?>
    <center>
        <div class="uniformity">
            ...
            <hr>
            <p>
                             <center> <input type="submit" value="Approve" style="background-color: #33ff33;color: #ffffff;" class="Inline"/>&nbsp;&nbsp;<a href="#rejectSample" id="Inline" style="background-color: #F00; color: #ffffff;">Reject</a></center>
