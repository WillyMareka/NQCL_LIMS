...
$("#date_of_results").datepicker({
    ...
    <BODY LANG="en-US" DIR="LTR">
        <P CLASS="western" STYLE="margin-bottom: 0in"><CENTER>
              <p>
                        Name: <input name="pname" typ="text" style="width:250px;" value="<?php //echo $active[0]->name;?>"/>
                    </p>
                    <br>
                ...
                <TR>
                    <TD COLSPAN=11 HEIGHT=61 STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
                        <P CLASS="western"><span class="western" style="margin-bottom: 0in">
                                <textarea name="sample_preparation" id="sample_preparation" style="height:100%; width: 1050px"><?php echo $d_info[0]->sample_preparation;?></textarea>
                            </span><BR>
                        </P>
                    </TD>
                </TR>
                ...
                <TR>
                    <TD COLSPAN=11 HEIGHT=9 STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
                        <P CLASS="western"><FONT FACE="Book Antiqua, serif"><FONT SIZE=2 STYLE="font-size: 11pt"><B>Comments:</B></FONT></FONT>
                            <textarea name="comments" id="comments" style="height:100%; width: 1050px"><?php echo $d_info[0]->comments;?></textarea>
                        </P>
                    </TD>
                </TR>
                <TR>
...
<?php if($d_info[0]->comply =='DOES NOT COMPLY'){;?>
                ...
                <input id="compendia" name="compendia" required="required" value="<?php echo $comspec[0]->compedia;?>"/>
               <label>SPECIFICATION:</label>
                <input id="specification" name="specification" required="required" value="<?php echo $comspec[0]->specification;?>"/>
            </div>
        </CENTER><BR>
