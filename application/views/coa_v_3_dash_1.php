        ...
        <center>
                 <table>
                    <tr>
                        ...
                        <td>  <a href="<?php echo site_url('directors/approve/'.$information[0]->request_id); ?>" class="btn btn-primary">Approve</a></td>
                        <td>  <a href="<?php echo site_url('directors/reject/'.$information[0]->request_id); ?>" class="btn btn-danger">Reject</a></td>
                    </tr>
                </table>
