...
<!--        <input type = "text" name = "ndqno" id = "lab_ref_no" />-->
        ...
        <tr>
            ...
            <td><input type = "text" name = "ndqno" id = "lab_ref_no" /></td>
        ...
        <tr id="my" class = "hidden2" >
            <td>Manufacture Date&nbsp;</td>
            <td><input type = "text" id = "m_date" 	name ="m_date" class = "validate[required] datepicker" data-month = "monthpicker" /></td>


            <td>Expiry Date</td>
            <td><input type = "text" id = "e_date" name = "e_date" class = "validate[required] datepicker" data-month = "monthpicker" /></td>
        <tr>
