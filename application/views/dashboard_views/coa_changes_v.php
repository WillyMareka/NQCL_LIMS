...
<div id="history" class="row-fluid" style="overflow: auto;">
    
   <a href="http://localhost/NQCL_LIMS/main_dashboard/samples/"><i class="icon-arrow-left"></i><span class="hidden-tablet">BACK</span></a>
